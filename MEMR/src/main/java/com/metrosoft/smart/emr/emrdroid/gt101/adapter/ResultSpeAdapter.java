...
public class ResultSpeAdapter  extends BaseExpandableListAdapter {
    private Context context;
    private ArrayList<HashMap<String,Object>> arrayList;
    private ArrayList<HashMap<String,Object>> resultList;

    public ResultSpeAdapter(Context context, ArrayList<HashMap<String,Object>> arrayList,ArrayList<HashMap<String,Object>> resultList) {
        this.context = context;
        this.arrayList = arrayList;
        this.resultList = resultList;
    }
    // 판독결과를 저장한다.
    public void setSpeResult(int position, String show, String result) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,	View convertView, ViewGroup parent) {
        ...
        if (row==null) {
            ...
            row = inflater.inflate(R.layout.result_spe_row_order, null);
        }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (row==null) {
            LayoutInflater inflater = ((Activity)this.context).getLayoutInflater();
            row = inflater.inflate(R.layout.result_spe_row_order_result, null);
        }
        ...
        TextView textView;
        // 결과
        textView = (TextView)row.findViewById(R.id.result_spe_text);
