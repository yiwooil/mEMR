...
import com.metrosoft.smart.emr.emrdroid.gt101.z_practice.ColorPickerDialog.OnColorChangedListener;
...
public class FingerPaint extends GraphicsActivity
    ...
    public class MyView extends View {
        ...
        public MyView(Context c) {
            ...
            Bitmap bm=null;
            mBGBitmap=Bitmap.createScaledBitmap(bm, metrics.widthPixels,metrics.heightPixels, true);
...
//            canvas.drawPath(mPath, mPaint);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, CLEAR_MENU_ID, 0, "초기화").setShortcut('5', 'z');
