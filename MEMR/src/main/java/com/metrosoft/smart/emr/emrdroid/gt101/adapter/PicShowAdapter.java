...
public class PicShowAdapter extends BaseAdapter {
    ...
    public PicShowAdapter(Context c, ArrayList<HashMap<String,Object>> arrayList){
        mContext = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String picIdx = (String)map.get("pic_idx");
        String exdtSeq = getFormattedDate(exdt) + "." + seq + "." + picIdx;
